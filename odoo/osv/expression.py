        ...
        while stack:
            ...
            # -------------------------------------------------
                ...
                if field.type == 'datetime' and right:
                    ...
                    if operator in ("like", "ilike", "=like", "=ilike") and right and isinstance(right, str) and right.startswith("^"):
                        # Remove wildcard % at the end to support use in (..., '=like', self+'%') domain
                        if right.endswith("$%"):
                            right = right.rstrip("%")
                        if right.endswith("$"):
                            operator = "regexp"
